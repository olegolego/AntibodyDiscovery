...
const CATEGORY_META: Record<string, { label: string; color: string; order: number }> = {
  ...
  bioinformatics:       { label: "Bioinformatics",      color: "#2dd4bf", order: 7  },
  control_flow:         { label: "Control Flow",        color: "#06b6d4", order: 8  },
  design:               { label: "Design",              color: "#f472b6", order: 9  },
  ml:                   { label: "ML",                  color: "#a3e635", order: 10 },
  loop:                 { label: "Loop",                color: "#facc15", order: 11 },
